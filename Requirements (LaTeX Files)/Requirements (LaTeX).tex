...
\begin{center}
	...
	\begin{spacing}{1.5}
	\begin{tabular}{c || c | c}
		\textbf{Cloud Paradigm} & \textbf{\underline{DynamoDB}} & \textbf{\underline{Cassandra}} \\
		\hline
		\hline
		\textbf{\emph{SaaS}} & AWS's DynamoDB SaaS Cloud Service &  \\
		\hline
		\textbf{\emph{PaaS}} & \emph{Docker} container on AWS's & \emph{Docker} container on AWS's \\
		 & Container Service & Container Service \\
		\hline
		\textbf{\emph{hybrid-PaaS/IaaS}} & A \emph{Docker} container on & A \emph{Docker} container on an AWS EC2 VM on \\
