...
\subsubsection{\underline{Containers} (code: \textbf{2\_})}\footnote{In the code \textbf{2\_}, we use the "\_" after the 2 is a place-holder for an additional code-letter.  This is due to the fact that there are two different versions of this platform being used.}
...
\begin{itemize}
	\item $\bigl[$\emph{\underline{AWS's Container Service} (code:} \textbf{2i}\emph{)}$\bigr]$
\end{itemize}
